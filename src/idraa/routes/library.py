...
@router.get("/library/export.csv", dependencies=[Depends(require_step_up(StepUpCategory.EXPORTS))])
...
@router.get("/library/export", dependencies=[Depends(require_step_up(StepUpCategory.EXPORTS))])
