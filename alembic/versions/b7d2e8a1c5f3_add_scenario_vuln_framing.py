...
scenarios for review (spec: internal design doc
2026-06-10-audit-remediation-f1-f2-design).
...
Backfill cutoff evidence (plan-gate SC-I1): the #339 cutover deploy completed
2026-06-10T09:28Z ("Application startup complete"); audited production data
was consistent with the cutoff. created_at is server-set (TimestampMixin),
not user-suppliable, so the cutoff cannot be gamed.
...
# Cutover deploy startup-complete 2026-06-10T09:28Z (#339 cutover).
