...
| --- | --- | --- |
| [![Idraa dashboard for an evaluation org: residual annualized loss $494.99k with a $67.79k–$1.51M modeled range, control value $801.93k/year (modeled 62% reduction, 26.7× control ROI), and loss-exceedance curves with and without controls](docs/readme/dashboard-2026-07.png)](docs/readme/dashboard-2026-07.png) | [![Aggregate-run detail: loss-exceedance curves comparing with-controls and without-controls loss distributions against an $8M-at-5% risk appetite line, with PDF report and Excel verification-workbook export buttons](docs/readme/loss-exceedance-2026-07.png)](docs/readme/loss-exceedance-2026-07.png) | [![Scenario wizard, step 1 of 6: picking a starting scenario from the curated library, filterable by asset class and threat actor](docs/readme/wizard-2026-07.png)](docs/readme/wizard-2026-07.png) |
...
- [FAIR-CAM methodology notes](docs/reference/fair-cam-methodology.md) — the Standard's structure as implemented, what was removed as not-FAIR, and the known limitations.
- [Reference docs index](docs/reference/) — calibration sources, loss-form model, τ calibration, weight robustness, and the rest.
- [Threat model](docs/security/threat-model.md) — the security boundaries the app is audited against.
